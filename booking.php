...
$check->execute();
$check->bind_result($activeBooking);
$check->fetch();
$check->close();
...
if ($activeBooking > 0) {
    ...
    echo "<a href='car-listings.php'>Back to Listings</a>";
    exit();
}
?>
...
<body>
    ...
    <div class="container" style="max-width: 600px; margin: 50px auto;">
        ...
        <?php if (!empty($car['image'])): ?>
            <img src="images/<?= htmlspecialchars($car['image']) ?>" alt="Car Image" class="img-fluid mb-3"
