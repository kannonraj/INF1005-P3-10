        ...
        <main class="container my-5 text-white">
            ...
            <main class="container my-5 text-white">
                ...
                <div class="faq-answer">
                    We offer a wide variety of cars, including economy, luxury, SUVs, and family vehicles. You can view
                    all
                ...
                <div class="faq-answer">
                    A valid driver’s license, an ID card or passport, and a valid credit or debit card are typically
                    required.
                </div>
                ...
                <div class="faq-answer">
                    Most rental companies require renters to be at least 21 years old. Some vehicles may require the
                    driver to
                ...
                <div class="faq-answer">
                    Some locations allow debit cards, but having a credit card is generally preferred and sometimes
                    required.
                </div>
                ...
                <div class="faq-answer">
                    Late returns may result in additional fees. It’s best to inform us ahead of time if you anticipate
                    delays.
                </div>
            </main>
