...
<head>
    ...
    <style>
        ...
        .car-box { border: 1px solid #ccc; padding: 20px; border-radius: 8px; background: #fff; }
        .car-box img { width: 100%; max-height: 400px; object-fit: cover; border-radius: 8px; }
        .review-box { margin-top: 40px; padding-top: 20px; border-top: 1px solid #ccc; }
    </style>
</head>
<body>
