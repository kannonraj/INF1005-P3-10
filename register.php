...
<head>
    ...
    <style>
        ...
        .register-table {
            ...
            margin: 0 15px;
            /* Ensure space around the container */
        }
        ...
        .register-form .form-group {
            ...
            margin-bottom: 15px;
            display: flex;
            /* Flexbox for label and input to be side by side */
            align-items: center;
        }
        ...
        .register-form .form-check {
            display: flex;
            /* Keep checkbox and label on the same line */
            align-items: center;
        ...
        .register-form .form-check-label {
            line-height: 1.5;
            /* Adjust line height to make the text appear straight */
            margin-left: 0;
            /* Remove left margin if needed */
            white-space: nowrap;
        ...
        @media (max-width: 768px) {
            ...
            .register-form label {
                width: 100%;
                /* Full width for labels on small screens */
                text-align: left;
            ...
            .register-form .form-control {
                width: 100%;
                /* Ensure input fields take up full width on mobile */
            }
        }
    </style>
</head>
